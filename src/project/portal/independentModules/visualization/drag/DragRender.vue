<template>
  <div :class="{'drag-render':componentName!='BaseLayout'}">
    <drag-button-group v-if="componentName!='BaseLayout'" class="drag-button-group" @removeItem='remove' @setProperty="setProperty"></drag-button-group>
...
<script>
  ...
  import componentsTree from 'portal/independentModules/visualization/config/dragAll.js'
  export default {
    name: "DragRender",
    components: {
      DragButtonGroup,
