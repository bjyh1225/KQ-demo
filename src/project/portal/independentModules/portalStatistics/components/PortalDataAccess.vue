<template>
  <el-row class="portal-map-access">
    ...
    <portal-statistics-map-dialog
      ...
      :totalPageTitle="$t('portalStatistics.Dataserviceresourcelist')"
    ></portal-statistics-map-dialog>
  </el-row>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      titleName:this.$t('portalStatistics.Datavisitstatistics'),
      histogram: "3", //默认显示柱状图
  ...
  methods: {
    ...
    changePageIndexFun() {
      this.$refs.dialogPortal.selectDataServiceAll();
    },
    // 数组相加合并
    merge(list, name, num) {
      let result = [];
    ...
    getDataServiceStatistcs() {
      ...
      this.$api.portalStatisticsApi
        .getPortalDataServiceStatistcs(this.serviceStatistcsData, {
    ...
    pieChartChartAll() {
      ...
      this.pieChartCharPublic(
        legendData,
        seriesType,
        this.$t('portalStatistics.Totaldatavisits'),
        "noUser"
      );
    },
    // 饼状图公共
    ...
    pieChartChart() {
      ...
      if (this.dataServiceName.length > 0 && this.dataUserId == "") {
        ...
        this.pieChartCharPublic(
          ...
          this.$t('portalStatistics.Datavisits'),
          "noUser"
        );
      } else if (
      ...
      brokenLineEchart.setOption(
        {
          ...
          title: {
            text: this.$t('portalStatistics.Totaldatavisits'),
            textStyle: {
              color: "#fff",
              fontSize: 16,
              fontWeight: "normal"
          ...
          legend: {
            data: [this.$t('portalStatistics.Alldata')],
            textStyle: {
              color: "#fff"
            },
            bottom: 30
          ...
          series: [
            {
              name: this.$t('portalStatistics.Alldata'),
              type: "bar",
              label: seriesLabel,
