      ...
      <el-col class="main">
        <div class="choice">
          ...
          <el-button type="primary" :class="!buttonChoiceAll?'graphic':''" @click="handleCommand">
            {{$t('portalStatistics.Selectfunction')}}
...
export default {
  ...
  data() {
    return {
      titleName: this.$t('portalStatistics.Functionvisitstatistics'),
      histogram: "3", //默认显示柱状图
  ...
  methods: {
    ...
    changePageIndexFun() {
      this.$refs.dialogPortal.selectFunctionServiceAll();
    },
    // 数组相加合并
    merge(list, name, num) {
      let result = [];
    ...
    getDataServiceStatistcs() {
      ...
      this.$api.portalStatisticsApi
        .getDataFunctionServiceStatistcs(this.serviceStatistcsData, {
    ...
    pieChartChartAll() {
      ...
      this.pieChartCharPublic(
        legendData,
        seriesType,
        this.$t('portalStatistics.Totalfunctionvisits'),
        "noUser"
      );
    },
    // 饼状图公共
    ...
    pieChartChart() {
      ...
      if (this.dataServiceName.length > 0 && this.dataUserId == "") {
        ...
        this.pieChartCharPublic(
          ...
          this.$t('portalStatistics.Functionvisits'),
          "noUser"
        );
      } else if (
      ...
      brokenLineEchart.setOption(
        {
          ...
          title: {
            text: this.$t('portalStatistics.Totalfunctionvisits'),
            textStyle: {
              color: "#fff",
              fontSize: 16,
              fontWeight: "normal"
          ...
          legend: {
            data: [this.$t('portalStatistics.Allfunctions')],
            textStyle: {
              color: "#fff"
            },
            bottom: 30
          ...
          series: [
            {
              name: this.$t('portalStatistics.Allfunctions'),
              type: "bar",
              label: seriesLabel,
