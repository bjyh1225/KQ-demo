<template>
  <el-row class="portal-map-access">
    ...
    <portal-statistics-map-dialog
      ...
      :totalPageTitle="$t('portalStatistics.Appresourcelist')"
    ></portal-statistics-map-dialog>
  </el-row>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      titleName: this.$t('portalStatistics.Appvisitstatistics'),
      histogram: "3", //默认显示柱状图
  ...
  methods: {
    ...
    changePageIndexFun() {
      this.$refs.dialogPortal.selectAppAll();
    },
    // 数组相加合并
    merge(list, name, num) {
      let result = [];
    ...
    getDataServiceStatistcs() {
      ...
      this.$api.portalStatisticsApi
        .getDataAppStatistcs(this.serviceStatistcsData, {
    ...
    pieChartChartAll() {
      ...
      this.pieChartCharPublic(
        legendData,
        seriesType,
        this.$t('portalStatistics.Totalappvisits'),
        "noUser"
      );
    },
    // 饼状图公共
    ...
    pieChartChart() {
      ...
      if (this.dataServiceName.length > 0 && this.dataUserId == "") {
        ...
        this.pieChartCharPublic(
          ...
          this.$t('portalStatistics.Appvisits'),
          "noUser"
        );
      } else if (
      ...
      brokenLineEchart.setOption(
        {
          ...
          title: {
            text: this.$t('portalStatistics.Totalappvisits'),
            textStyle: {
              color: "#fff",
              fontSize: 16,
              fontWeight: "normal"
          ...
          legend: {
            data: [this.$t('portalStatistics.AllApps')],
            textStyle: {
              color: "#fff"
            },
            bottom: 30
          ...
          series: [
            {
              name: this.$t('portalStatistics.AllApps'),
              type: "bar",
              label: seriesLabel,
