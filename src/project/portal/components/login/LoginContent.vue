    ...
    <el-row>
      <el-col :span="14">
        <div class="left-content">
          <img src="~img/login_leftimg.png" alt="login-left" class="left-content-img" />
        </div>
      </el-col>
      <el-col :span="10">
        <div class="right-content">
          <div class="right-content-form">
            <div class="right-content-logintext">
              ...
              <span class="logintext-center">{{$t("myCenter.Systemlogin")}}</span>
...
<script>
import {loginHandle,getRememberPassword} from "common/loginHandle/loginHandle.js";
export default {
  name: "LoginContent",
  data() {
    return {
