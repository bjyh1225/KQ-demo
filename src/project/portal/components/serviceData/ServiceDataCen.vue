...
<template>
  <div id="service-center" :style="'margin-top:'+homePageHeaderHeight+'px'">
      ...
      <el-col :span="10">
        <el-row type="flex" justify="space-between" class="map-search">
          <el-col :span="20">
            <div class="inp">
              <el-input
                :placeholder="$t('myCenter.Searchdataservices')"
                v-model="searchVal"
    ...
    <el-row type="flex" justify="space-around">
      <el-col :span="5">
        <side-bar-menu
          :categoryTitle="$t('myCenter.Dataservicecategory')"
      ...
      <el-col :span="17">
        ...
        <map-resource-display
          ...
          @saveKqServiceTop="saveDataServiceTop"
          @deleteKqServiceTop="deleteDataServiceTop"
          @deleteServiceCollection="deleteDataServiceCollection"
          @order="order"
...
export default {
  data() {
    return {
      ...
      serviceName: this.$t("portalStatistics.DataService"),
      searchVal: "", //top搜索框值
      serviceClassify: "", //侧边栏
      ...
      pageShow: false,
      all: "全部",
      portalIcon: "el-icon-portal-shujufuwuqi"
    };
  },
  name: "ServiceDataCen",
  components: {
  ...
  methods: {
    ...
    //请求  取消置顶 0
    deleteDataServiceTop(row) {
      this.$api.serviceDataApi
        .deleteDataServiceTop(
          {
            TOPID: row.topId,
    ...
    //取消收藏
    deleteDataServiceCollection(row) {
