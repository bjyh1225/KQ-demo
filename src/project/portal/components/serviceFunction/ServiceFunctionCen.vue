<template>
  <div id="service-center" :style="'margin-top:'+homePageHeaderHeight+'px'">
      ...
      <el-col :span="10">
        <el-row type="flex" justify="space-between" class="map-search">
          <el-col :span="20">
            <div class="inp">
              <el-input
                :placeholder="$t('service.searchFunctionService')"
                v-model="searchVal"
    ...
    <el-row type="flex" justify="space-around">
      <el-col :span="5">
        <side-bar-menu
          :categoryTitle="$t('management.categoriesOfFunctionServices')"
      ...
      <el-col :span="17">
        ...
        <map-resource-display
          ...
          @saveKqServiceTop="saveFServiceTop"
          @deleteKqServiceTop="deleteFServiceTop"
          @deleteServiceCollection="deleteServiceCollection"
          @order="order"
          @dropdownSortList="dropdownSortList"
          @getListService="getListfunctionService"
...
export default {
  data() {
    return {
      ...
      serviceName: this.$t("service.functionServices"),
      searchVal: "", //top搜索框值
      serviceClassify: "", //侧边栏
      ...
      pageShow: false,
      all: "全部",
      portalIcon: "el-icon-portal-gongnengshezhi"
    };
  },
  name: "ServiceFunctionCen",
  components: {
    MapResourceDisplay,
    SideBarMenu,
    Pagination,
  ...
  methods: {
    ...
    getMyKeyWord() {
      this.$api.serviceFunctionApi
        .getMyKeyWord({}, { loadingText: this.$t("service.searching") })
        .then(res => {
           this.myKeyWordData = [];
        ...
        .getListfunctionService(
          {
            ...
            serviceClassify: this.serviceClassify?this.serviceClassify:this.serviceClassifyParent,
            serviceClassifyParent: this.serviceClassifyParent,
