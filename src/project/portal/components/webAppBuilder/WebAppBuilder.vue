      ...
      <el-col :span="10">
        <el-row type="flex" justify="space-between" class="map-search">
          <el-col :span="20">
            <div class="inp">
              <el-input
                :placeholder="$t('service.SearchApps')"
                v-model="searchVal"
    ...
    <el-row type="flex" justify="space-around">
      <el-col :span="5">
        <side-bar-menu
          ...
          :portalIcon="'el-icon-portal-yonghufenzuyingyong'"
...
export default {
  data() {
    return {
      MapResourceDisplayProps: {
        ...
        appJumpTitle: this.$t("webAppBuilder.CustomApplication"),
        appJumpIcon: "el-icon-portal-yonghufenzuyingyong",
        pnav:'',//父导航
        snav:''//子导航
      },
      pageShowProps: {
  ...
  methods: {
    ...
    clickServiceDetails(val) {
      this.$emit("getAppDetails", { appId: val, appMes: true });
    },
