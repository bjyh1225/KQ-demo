...
<template>
  <div class="service-center" :style="'margin-top:'+homePageHeaderHeight+'px'">
      ...
      <el-col :span="10">
        <el-row type="flex" justify="space-between" class="map-search">
          <el-col :span="20">
            <div class="inp">
              <el-input
                :placeholder="$t('myCenter.Searchbigscreenapps')"
                v-model="searchVal"
    ...
    <el-row type="flex" justify="space-around">
      <el-col :span="5">
        <side-bar-menu
          :portalIcon="'el-icon-portal-daping'"
          :categoryTitle="$t('myCenter.Bigscreencategory')"
          :publicField="$t('myCenter.Publicbigscreen')"
          :myCenterField="$t('myCenter.Mybigscreen')"
  ...
  data() {
    return {
      MapResourceDisplayProps: {
        ...
        appJumpTitle: this.$t("myCenter.Makebigscreen"),
        appJumpIcon: "el-icon-portal-daping",
        pnav:'',//父导航
        snav:''//子导航
      },
      pageShowProps: {
      ...
      serviceName: this.$t('group.Bigscreen'),
      searchVal: "", //top搜索框值
      serviceClassify: "", //侧边栏
