    ...
    <el-row type="flex" justify="space-around">
      ...
      <el-col :span="17">
        <map-resource-display
          ...
          @saveKqServiceTop="saveKqServiceTop"
          @deleteKqServiceTop="deleteKqServiceTop"
  ...
  data() {
    return {
      ...
      MapResourceDisplayProps: {
        ...
        instructions: "el-icon-portal-diqiu",
      ...
      serviceName: this.$t("service.mapServices"),
      searchVal: "", //top搜索框值
      serviceClassify: "", //侧边栏
      ...
      keyWord: "", //选中关键字
      category: [],
      showSunNoData: false, //左侧子级暂无数据默认隐藏
      activeIndex: "",
      indexreplace: "",
      pageSizes: [12, 24, 36],
      pageIndex: 0,
