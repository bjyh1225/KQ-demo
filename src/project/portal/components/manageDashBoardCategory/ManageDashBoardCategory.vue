...
export default {
      ...
      checkTypeName: (rule, value, callback) => {
        ...
        rules.execute([
          ...
          },
          {
            ...
            api: this.$api.webDashBoardBuilderApi.getBigbuilderCategoryOnly,
            params: {
  ...
  methods: {
      ...
      this.$api.webDashBoardBuilderApi
        ...
        .then(res => {
          ...
          var root = {
            parentId: "-1",
            id: 0,
            typeName: this.$t("myCenter.Bigscreencategory"),
            comments: ""
          };
          data.push(root);
    ...
    save() {
      this.$api.webDashBoardBuilderApi
        .saveBigbuilderCategory(this.serviceCategoryInfo, {
