...
<template>
  <div id="service-center" :style="'margin-top:'+homePageHeaderHeight+'px'">
      ...
      <el-col :span="10">
        <el-row type="flex" justify="space-between" class="map-search">
          <el-col :span="20">
            <div class="inp">
              <el-input
                :placeholder="$t('service.Search3DServices')"
                v-model="searchVal"
    ...
    <el-row type="flex" justify="space-around">
      <el-col :span="5">
        <side-bar-menu
          :categoryTitle="$t('management.ThreeDServiceCategory')"
      ...
      <el-col :span="17">
        ...
        <map-resource-display
          ...
          @saveKqServiceTop="savesceneServiceTop"
          @deleteKqServiceTop="deletesceneServiceTop"
          @deleteServiceCollection="deleteSceneServiceCollection"
          @order="order"
...
export default {
  data() {
    return {
      ...
      serviceName: this.$t("service.scene"),
      searchVal: "", //top搜索框值
      serviceClassify: "", //侧边栏
      ...
      pageShow: false,
      all: "全部",
      portalIcon: "el-icon-portal-diqiu1"
    };
  },
  name: "ServiceSceneCen",
  components: {
    MapResourceDisplay,
    SideBarMenu,
    Pagination,
  ...
  methods: {
    ...
    //请求  取消置顶 0
    deletesceneServiceTop(row) {
      this.$api.serviceSceneApi
        .deletesceneServiceTop(
          {
            TOPID: row.topId,
    ...
    //取消收藏
    deleteSceneServiceCollection(row) {
