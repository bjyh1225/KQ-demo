    ...
    <el-row>
      <el-col :span="8">
        <manage-service-category-tree
          ...
          :placeholder="$t('management.pleaseEnterTheFileCategory')"
        ></manage-service-category-tree>
      </el-col>
...
export default {
      ...
      checkTypeName: (rule, value, callback) => {
        ...
        rules.execute([
          ...
          },
          {
            ...
            api: this.$api.manageFileCategoryApi.checkTypeName,
            params: {
  ...
  methods: {
    ...
    getFileCategory() {
      this.resetInfo();
      this.$api.manageFileCategoryApi
        .getFileCategory({
        ...
        .then(res => {
          ...
          var root = {
            parentId: "-1",
            id: 0,
            typeName: this.$t("management.MyFileCategory"),
            comments: ""
          };
          data.push(root);
    ...
    save() {
      this.$api.manageFileCategoryApi
        .saveFileCategory(this.serviceCategoryInfo, {
