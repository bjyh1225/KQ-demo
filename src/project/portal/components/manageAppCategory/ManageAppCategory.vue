    ...
    <el-row>
      <el-col :span="8">
        <manage-service-category-tree
          :draggable="draggable"
          :placeholder="$t('management.Pleaseentertheappcategory')"
...
export default {
      ...
      checkTypeName: (rule, value, callback) => {
        ...
        rules.execute([
          ...
          },
          {
            ...
            api: this.$api.manageAppCategoryApi.checkTypeName,
            params: {
  ...
  methods: {
      ...
      this.$api.manageAppCategoryApi
        ...
        .then((res) => {
          ...
          var root = {
            parentId: "-1",
            id: 0,
            typeName: this.$t("management.AppsCenterCategory"),
            comments: "",
          };
          data.push(root);
    ...
    save() {
      this.$api.manageAppCategoryApi
        .saveAppCategory(this.serviceCategoryInfo, {
