...
export default {
      ...
      checkTypeName: (rule, value, callback) => {
        ...
        rules.execute([
          ...
          },
          {
            ...
            api: this.$api.webMapBuilderApi.getMapbuilderCategoryOnly,
            params: {
  ...
  methods: {
      ...
      this.$api.webMapBuilderApi
        ...
        .then(res => {
          ...
          var root = {
            parentId: "-1",
            id: 0,
            typeName: this.$t("myCenter.Mappingcategory"),
            comments: ""
          };
          data.push(root);
    ...
    save() {
      this.$api.webMapBuilderApi
        .saveMapbuilderCategory(this.serviceCategoryInfo, {
