...
export default {
  ...
  methods: {
      ...
      this.$api.webAppBuilderApi
        ...
        .catch(res => {
          if (res.data.status == 392) {
            this.$message({
              message: this.$t('myCenter.NopermissionstomodifyitnowFailedtosubmitthemodification'),
              type: "warning"
            });
            this.editNameDialogVisible = false;
          }
    ...
    updateDataTask() {
      ...
      if (!this.currentAppInfo.configJson) {
        ...
        this.currentAppInfo.allLayerConfigJson = {};
        this.currentAppInfo.allLayerConfigXml = "";
      } else {
        ...
        if (!this.currentAppInfo.allLayerConfigJson) {
          this.currentAppInfo.allLayerConfigJson = {};
        } else {
          this.currentAppInfo.allLayerConfigJson = JSON.parse(
            this.Base64.decode(this.currentAppInfo.allLayerConfigJson)
          );
        }
        ...
        this.currentAppInfo.allLayerConfigXml = jsXmlUtil.js2xml(
          this.currentAppInfo.allLayerConfigJson
        );
      }
      for (var i in this.fieldMapping) {
  ...
  data() {
    return {
      ...
      allLayerConfigJSON: {}, //四川项目微件JSON
      allLayerConfigXML: "", //四川项目微件XMl
      copyAllLayerConfigJSON: {}, //四川项目微件JSON备份
      ...
      fieldMapping: {
        ...
        allLayerConfigJson: "allLayerConfigJSON",
        allLayerConfigXml: "allLayerConfigXML"
      }, //字段映射
      xmlJsonMapping: {
        ...
        allLayerConfigJson: "allLayerConfigXml"
      }, //xml和json的映射
      copyFieldMapping: {
        ...
        allLayerConfigJSON: "copyAllLayerConfigJSON"
      } //备份字段映射
    };
  },
  created() {
